...
<svelte:head>
	<title>SvelteKit + Supabase + Vercel Template</title>
	<meta
		name="description"
		content="A production-ready SvelteKit template with Supabase, Tailwind CSS, and automated deployment to Vercel."
	/>
</svelte:head>
